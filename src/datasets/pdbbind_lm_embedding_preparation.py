...
parser.add_argument('--data_dir', type=str, default='D:\PythonProject medicine\project_mine\data/PDBBind', help='')
parser.add_argument('--chain_cutoff', type=int, default=10, help='')
parser.add_argument('--out_file', type=str, default="D:\PythonProject medicine\project_mine\data/PDBBind_sequences.fasta")
