...
def optimize_rotatable_bonds(mol, true_mol, rotable_bonds, probe_id=-1, ref_id=-1, seed=0, popsize=15, maxiter=500,
    ...
    result = differential_evolution(opt.score_conformation, bounds,
                                    ...
                                    mutation=mutation, recombination=recombination, disp=False, seed=seed) # type: ignore
...
def mmff_func(mol):
    ...
    AllChem.MMFFOptimizeMoleculeConfs(mol_mmff, mmffVariant='MMFF94s') # type: ignore
...
RMSD = AllChem.AlignMol # type: ignore