...
# from .score_model import AtomEncoder, TensorProductConvLayer, GaussianSmearing
from .layers.common import AtomEncoder, GaussianSmearing
from project_mine.src.datasets.process_mols import lig_feature_dims, rec_residue_feature_dims, rec_atom_feature_dims
