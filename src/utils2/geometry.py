...
def diff_between_two_axis_angle(a1, b1):
    # a1: X -> Y
    # b1: X -> Z
    # return: Y -> Z

    mat1 = axis_angle_to_matrix(a1)
    mat2 = axis_angle_to_matrix(b1)

    mat3 = mat2 @ mat1.T  # Y -> Z

    reverse = matrix_to_axis_angle(mat3)
    return reverse

def diff_between_two_axis_angle_numti(a1, b1):
    # a1: X -> Y, N x 3
    # b1: X -> Z, N x 3
    # return: Y -> Z
    ...
    mat3 = torch.matmul(mat2, mat1.permute(0, 2, 1))  # Y -> Z
...
# print(diff_between_two_axis_angle_numti(a, b))
# print([diff_between_two_axis_angle(a[i], b[i]) for i in range(3)])